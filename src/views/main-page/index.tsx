      ...
      <div className="main-page">
        ...
        <div className="welcome">
            <div className="left">
              ...
              <p>Keep tracking your baby, and shop form all your favorite brands</p>
        ...
        <div className="baby-section">
          ...
          <div className="baby-food">
            ...
            <ul>
              ...
              <li>Weighs at least 13 pounds or has doubled their birth weigh</li>
            </ul>
            ...
            <div className="baby-eat">
              ...
              <div className="foods">
                    <img src={icon2} alt="" />
                    <p>Pureed food ( potato-apples-carrot-bananas-peaches or pears)</p>
              </div>
              <div className="foods">
                    <img src={icon3} alt="" />
                    <p>Semi-liquid iron-fortified cereal</p>
              </div>
              <p className="introdu">introducing one new ingredient at a time for
                three days then, you can mix and match.</p>
                <div className="hint">
                  <div><span>hint</span></div>
                  <p>start with veggies as children are born 
                  with innate preference for sweet food.</p>
                </div>
            </div>
          </div>
        </div>
